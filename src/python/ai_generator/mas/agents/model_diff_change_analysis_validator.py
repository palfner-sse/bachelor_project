...
from ai_generator.mas.agents.system_prompts import MODEL_DIFF_CHANGE_ANALYSIS_VALIDATOR_PROMPT, \
    MODEL_DIFF_CHANGE_ANALYSIS_VALIDATOR_PATH_PROMPT, BUML_DOKUMENTATION
from ai_generator.mas.util import add_agent_history, add_proposed_environmental_changes, add_model_diff, \
    add_global_messages, add_task_list, add_models, add_issues, run_with_retry
